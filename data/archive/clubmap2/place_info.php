...
function storePlaceInfo($placeid,$conn,$APIKey){
	...
	echo "<br>";
		...
		$sql = "INSERT INTO placeInfo (name, place_id, url, geocoord_lat, geocoord_long, address, mon_closing_time, tues_closing_time, wed_closing_time, thurs_closing_time, fri_closing_time, sat_closing_time, sun_closing_time, rating)
		VALUES ('$name', '$placeid', '$url','$geo_coord_lat','$geo_coord_long','$address','$mon_closing_time','$tues_closing_time','$wed_closing_time','$thurs_closing_time','$fri_closing_time','$sat_closing_time','$sun_closing_time','$rating') ";
