...
<html>
  <head>
    ...
    <?php
    	$urlofaddress = urlencode("nightclubslondonplacedetails.json");
    ...
    <?php
        function latlgn($index,&$resp_add) {
            ...
            $lati = $resp_add['results'][$index]['lat'];
            $longi = $resp_add['results'][$index]['lng'];
            echo "{$lati},{$longi},";  
        } 
        
        function rating($index,&$resp_add) {
            $rating = $resp_add['results'][$index]['rating'];
            echo "{$rating},";              
        } 
        
        function names($index,&$resp_add) {
            $nameofpub = $resp_add['results'][$index]['name'];  
            echo "\"{$nameofpub}\",";  
        } 

        function noratings($index,&$resp_add) {
            $noratings = $resp_add['results'][$x]['user_ratings_total'];  
            echo "\"{$noratings}\",";  
        } 
